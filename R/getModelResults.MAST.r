...
#' @param contrast.type character, the type of contrast being extracted. Must be specified, as logFC can only be extracted for binary and/or continuous contrasts. For categorical contrasts, only significance values are extracted. Options are "continuous", "binary", "categorical"; partial matches allowed.
